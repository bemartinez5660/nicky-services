...
class CarpetBuildingTypeController extends GetxController {
  ...
  Future<List<dynamic>> carpetBuildingTypeQuery() async {
    ...
    QueryResult result = await _client.query(
      QueryOptions(document: gql(gql_str.carpetBuildingType)),
    );
